...
**定位**：pyxis 不对标 Claude Desktop 的聊天体验。它适合把 LLM 当作结构化数据生成器：
...
- **Claude（我）——AI 产品经理**。负责把方向落到 API 设计、技术选型、
...
- **函数边界**：pyxis 把一次 LLM 调用收束成可组合、可替换、可测试的函数。
...
1. 产品 / 定位层变化，直接改 `docs/concepts/`、`README.md`、`CLAUDE.md`。
